...
type TeamMessage struct {
	...
	SkypeItemId *string `protobuf:"bytes,20,opt,name=skype_item_id,json=skypeItemId,proto3,oneof" json:"skype_item_id,omitempty" msg:"1392231,omitempty"`  
	// Contains the subject of the message.
	Subject *string `protobuf:"bytes,21,opt,name=subject,proto3,oneof" json:"subject,omitempty" msg:"5531,omitempty"`  
}
